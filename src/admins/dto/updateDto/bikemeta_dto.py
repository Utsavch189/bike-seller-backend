...
class UpdateBikeMetaDTO(BaseModel):
    bikemeta_id:constr(min_length=1,max_length=100,strip_whitespace=True)
    bike:constr(min_length=1,max_length=100,strip_whitespace=True)
    ...
    latest_upload:constr(min_length=1,max_length=100,strip_whitespace=True)